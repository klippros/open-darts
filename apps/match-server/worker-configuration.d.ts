/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8fc8748984897aaba7f092b2febac6c)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	SUPABASE_URL: string;
	SUPABASE_JWT_SECRET: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	MATCH: DurableObjectNamespace<import("./src/index").MatchObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_JWT_SECRET" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
