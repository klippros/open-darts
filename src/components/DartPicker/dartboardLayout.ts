...
export const DARTBOARD_NUMBER_LABEL_RADIUS =
  DARTBOARD_INNER_RADIUS + (DARTBOARD_OUTER_RADIUS - DARTBOARD_INNER_RADIUS) * 0.65
...
export const DARTBOARD_TEXT_CLASS = 'dartboard-text'
